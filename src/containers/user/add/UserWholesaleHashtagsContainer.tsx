...
import UserWholesaleHashtagContainer from './UserWholesaleHashtagContainer';

const UserWholesaleHashtagsContainer: React.FC = () => {
...
export default React.memo(UserWholesaleHashtagsContainer);
