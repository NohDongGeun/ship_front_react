...
import UserWholesaleCategoryContainer from './UserWholesaleCategoryContainer';
...
const UserWholesaleCategoriesContainer: React.FC = () => {
            ...
            {categories.size > 0 && (
                <AddedWrapper>
                    {categories.map((item, index) => (
                        <UserWholesaleCategoryContainer
                            key={index}
                            categoryName={item}
                            categoryIndex={index}
...
export default React.memo(UserWholesaleCategoriesContainer);
