...
import MarketHashtagItemContainer from './MarketHashtagItemContainer';

const MarketHashtagContainer: React.FC = () => {
...
export default React.memo(MarketHashtagContainer);
