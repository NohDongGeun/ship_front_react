...
const QnaServiceCategoryContainer: React.FC = () => {
    const sesssion = useSession();
    const serviceCategory = useEditQnaStore(
        (state) => state.qna.serviceCategory
    );
...
export default React.memo(QnaServiceCategoryContainer);
