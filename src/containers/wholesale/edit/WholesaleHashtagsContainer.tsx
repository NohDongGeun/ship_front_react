...
import WholesaleHashtagContainer from './WholesaleHashtagContainer';

const WholesaleHashtagsContainer: React.FC = () => {
...
export default React.memo(WholesaleHashtagsContainer);
