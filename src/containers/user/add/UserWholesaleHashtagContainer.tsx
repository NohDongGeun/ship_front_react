...
interface IUserWholesaleHashtagContainer {
    hashtagName: string | '';
    hashtagIndex: number;
...
const UserWholesaleHashtagContainer: React.FC<IUserWholesaleHashtagContainer> = ({
    hashtagName,
    hashtagIndex,
    onSaveHashtag,
    onDeleteHashtag,
...
export default React.memo(UserWholesaleHashtagContainer);
