...
interface IMarketHashtagItemContainer {
    hashtagName: string | '';
    hashtagIndex: number;
...
const MarketHashtagItemContainer: React.FC<IMarketHashtagItemContainer> = ({
    hashtagName,
    hashtagIndex,
    onSaveHashtag,
    onDeleteHashtag,
...
export default React.memo(MarketHashtagItemContainer);
