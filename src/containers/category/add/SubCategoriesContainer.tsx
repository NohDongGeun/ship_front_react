...
const SubCategoriesContainer: React.FC = () => {
    ...
    const middleCategories = useAddCategoryStore(
        (state) => state.category.middleCategories
    );
    const addMiddleCategories = useAddCategoryStore(
        (state) => state.addMiddleCategories
    );
    const editMiddleCategories = useAddCategoryStore(
        (state) => state.editMiddleCategories
    );
    const deleteMiddleCategories = useAddCategoryStore(
